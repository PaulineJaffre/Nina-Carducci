 ...
 */ !(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? (module.exports = t()) : "function" == typeof define && define.amd ? define(t) : ((e = "undefined" != typeof globalThis ? globalThis : e || self).bootstrap = t());
            ...
            b = d
                ? ((r = e),
                  ...
                  function e(t) {
                      ...
                      for (let { target: n } = t; n && n !== this; n = n.parentNode) for (let s = i.length; s--; ) if (i[s] === n) return (t.delegateTarget = n), e.oneOff && j.off(r, t.type, o, a), a.apply(n, [t]);
                      return null;
                  })
                : ((l = e),
                  (c = i),
    ...
    let j = {
            ...
            trigger(e, t, i) {
                ...
                let n = m(),
                    ...
                    h = null;
                return (
                    t !== s && n && ((o = n.Event(t, i)), n(e).trigger(o), (a = !o.isPropagationStopped()), (l = !o.isImmediatePropagationStopped()), (c = o.isDefaultPrevented())),
                    r ? (h = document.createEvent("HTMLEvents")).initEvent(s, a, !0) : (h = new CustomEvent(t, { bubbles: a, cancelable: !0 })),
                    void 0 !== i &&
    ...
    let J = {
        ...
        er = { interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean", touch: "boolean" },
        eo = "next",
        ea = "prev",
        el = "left",
        ec = "right",
    ...
    class eT extends z {
        ...
        _getConfig(e) {
            return h(et, (e = { ...es, ...J.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), er), e;
        }
        _handleSwipe() {
        ...
        _addEventListeners() {
            this._config.keyboard && j.on(this._element, ef, (e) => this._keydown(e)),
                "hover" === this._config.pause && (j.on(this._element, ep, (e) => this.pause(e)), j.on(this._element, eg, (e) => this.cycle(e))),
        ...
        _addTouchEventListeners() {
            ...
            ee.find(".carousel-item img", this._element).forEach((e) => {
                ...
                this._pointerEvent
                    ? (j.on(this._element, eb, (e) => t(e)), j.on(this._element, ey, (e) => n(e)), this._element.classList.add("pointer-event"))
                    : (j.on(this._element, em, (e) => t(e)), j.on(this._element, e8, (e) => i(e)), j.on(this._element, ev, (e) => n(e)));
        }
        _keydown(e) {
    ...
    class eR extends z {
        ...
        _getConfig(e) {
            return ((e = { ...ex, ...J.getDataAttributes(this._element), ...e }).toggle = Boolean(e.toggle)), (e.parent = c(e.parent)), h(ek, e, e9), e;
        }
        _getDimension() {
    ...
    let tT = {
        ...
        fn: function e(t) {
            ...
            if (o && a) {
                var d,
                    u,
                    f = ((d = r.padding), (u = n), tA("number" != typeof (d = "function" == typeof d ? d(Object.assign({}, u.rects, { placement: u.placement })) : d) ? d : tC(d, eV))),
                    p = th(o),
    ...
    function tO(e) {
        var t,
            ...
            p = e.adaptive,
            g = e.roundOffsets,
            m = !0 === g ? ((s = (n = d).x), (r = n.y), { x: tE(tE(s * (o = window.devicePixelRatio || 1)) / o) || 0, y: tE(tE(r * o) / o) || 0 }) : "function" == typeof g ? g(d) : d,
            v = m.x,
            b = void 0 === v ? 0 : v,
            y = m.y,
            E = void 0 === y ? 0 : y,
        ...
        if (p) {
            var k = t8(a),
                L = "clientHeight",
                O = "clientWidth";
            k === tn(a) && ((k = tp(a)), "static" !== tu(k).position && "absolute" === u && ((L = "scrollHeight"), (O = "scrollWidth"))),
                ("top" === c || ((c === eF || c === eq) && "end" === h)) && ((C = ez), (E -= k[L] - l.height), (E *= f ? 1 : -1)),
                (c === eF || (("top" === c || c === ez) && "end" === h)) && ((A = eq), (b -= k[O] - l.width), (b *= f ? 1 : -1));
        }
        var x = Object.assign({ position: u }, p && tL);
        return f
            ? Object.assign({}, x, (((i = {})[C] = w ? "0" : ""), (i[A] = $ ? "0" : ""), (i.transform = 1 >= (T.devicePixelRatio || 1) ? "translate(" + b + "px, " + E + "px)" : "translate3d(" + b + "px, " + E + "px, 0)"), i))
            : Object.assign({}, x, (((t = {})[C] = w ? E + "px" : ""), (t[A] = $ ? b + "px" : ""), (t.transform = ""), t));
    }
    let tx = {
        name: "computeStyles",
        enabled: !0,
        ...
        fn: function e(t) {
            var i = t.state,
                ...
                o = n.roundOffsets,
                a = void 0 === o || o,
                l = { placement: tl(i.placement), variation: tk(i.placement), popper: i.elements.popper, popperRect: i.rects.popper, gpuAcceleration: void 0 === s || s };
            null != i.modifiersData.popperOffsets &&
                (i.styles.popper = Object.assign({}, i.styles.popper, tO(Object.assign({}, l, { offsets: i.modifiersData.popperOffsets, position: i.options.strategy, adaptive: void 0 === r || r, roundOffsets: a })))),
                null != i.modifiersData.arrow && (i.styles.arrow = Object.assign({}, i.styles.arrow, tO(Object.assign({}, l, { offsets: i.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: a })))),
    ...
    function tz(e, t) {
        ...
        var i,
            ...
            O = v === e0 ? L : T,
            x = { top: C.top - O.top + $.top, bottom: O.bottom - C.bottom + $.bottom, left: C.left - O.left + $.left, right: O.right - C.right + $.right },
                        ...
                        y = [v]
                            ...
                            .reduce(function (e, t) {
                                ...
                                return e.concat(
                                    tl(t) === eU
                                        ? ((n = i),
                                          (s = { placement: t, boundary: d, rootBoundary: u, padding: h, flipVariations: g, allowedAutoPlacements: m }),
                                          (o = (r = s).placement),
                                          (a = r.boundary),
                                          (l = r.rootBoundary),
                                          (c = r.padding),
                                          ...
                                          Object.keys(
                                              ($ = E.reduce(function (e, t) {
                                                  return (e[t] = tz(n, { placement: t, boundary: a, rootBoundary: l, padding: c })[tl(t)]), e;
                                              }, {}))
                                          ).sort(function (e, t) {
                                              return $[e] - $[t];
                                          }))
    ...
    let tV = {
            ...
            fn: function e(t) {
                var i = t.state,
                    ...
                    d = tU(c),
                    u = tU(h);
                (i.modifiersData[n] = { referenceClippingOffsets: c, popperEscapeOffsets: h, isReferenceHidden: d, hasPopperEscaped: u }),
                    (i.attributes.popper = Object.assign({}, i.attributes.popper, { "data-popper-reference-hidden": d, "data-popper-escaped": u }));
            },
        },
        tK = {
            name: "offset",
                    ...
                    a = e3.reduce(function (e, t) {
                        ...
                        return (
                            (e[t] =
                                ...
                                (h = (c = "function" == typeof r ? r(Object.assign({}, s, { placement: n })) : r)[0]),
                                (d = c[1]),
                                (h = h || 0),
                                (d = (d || 0) * l),
        ...
        tX = {
            ...
            fn: function e(t) {
                var i = t.state,
                    n = t.name;
                i.modifiersData[n] = tR({ reference: i.rects.reference, element: i.rects.popper, strategy: "absolute", placement: i.placement });
            },
            data: {},
        },
        tY = {
    ...
    function t1(e) {
        ...
        return function e(t, i, s) {
            ...
            var o,
                a,
                l = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, t0, r), modifiersData: {}, elements: { reference: t, popper: i }, attributes: {}, styles: {} },
                c = [],
                h = !1,
                d = {
                    state: l,
                    setOptions: function e(s) {
                        ...
                        u(), (l.options = Object.assign({}, r, l.options, b)), (l.scrollParents = { reference: ts(t) ? tB(t) : t.contextElement ? tB(t.contextElement) : [], popper: tB(i) });
                        var y =
                            ((v =
                                ((f = h = Object.keys(
                            ...
                            if (tQ(y, E)) {
                                (l.rects = {
                                    reference:
                                        ...
                                        (o = tr(s)),
                                        tr(s) && ((u = (c = (a = s).getBoundingClientRect()).width / a.offsetWidth || 1), c.height, a.offsetHeight),
                                        (p = tp(s)),
                                        (g = tc(n)),
                                        (m = { scrollLeft: 0, scrollTop: 0 }),
                                        (v = { x: 0, y: 0 }),
                                        (o || (!o && !r)) &&
                                            (("body" !== ti(s) || tH(p)) && (m = ((t = s), t !== tn(t) && tr(t) ? { scrollLeft: (i = t).scrollLeft, scrollTop: i.scrollTop } : tP(t))),
                                            tr(s) ? ((v = tc(s)), (v.x += s.clientLeft), (v.y += s.clientTop)) : p && (v.x = tM(p))),
                                        { x: g.left + m.scrollLeft - v.x, y: g.top + m.scrollTop - v.y, width: g.width, height: g.height }),
                                    popper: th(E),
                                }),
                                    (l.reset = !1),
                                ...
                                for (var $ = 0; $ < l.orderedModifiers.length; $++) {
                                    ...
                                    var w = l.orderedModifiers[$],
                                        ...
                                        T = void 0 === C ? {} : C,
                                        k = w.name;
                                    "function" == typeof A && (l = A({ state: l, options: T, name: k, instance: d }) || l);
                                }
                            }
                        }
                    },
    ...
    let tG = Object.freeze({
        ...
        iE = { offset: [0, 2], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, autoClose: !0 },
    ...
    class iw extends z {
        ...
        _getConfig(e) {
            if (
                (h(tZ, (e = { ...this.constructor.Default, ...J.getDataAttributes(this._element), ...e }), this.constructor.DefaultType),
    ...
    let ik = { className: "modal-backdrop", isVisible: !0, isAnimated: !1, rootElement: "body", clickCallback: null },
        iL = { className: "string", isVisible: "boolean", isAnimated: "boolean", rootElement: "(element|string)", clickCallback: "(function|null)" },
        iO = "backdrop",
        ix = "show",
        i9 = `mousedown.bs.${iO}`;
    class iD {
        ...
        _getConfig(e) {
            return ((e = { ...ik, ...("object" == typeof e ? e : {}) }).rootElement = c(e.rootElement)), h(iO, e, iL), e;
        }
        _append() {
            !this._isAppended &&
    ...
    class iZ extends z {
        ...
        _getConfig(e) {
            return h(iB, (e = { ...iR, ...J.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), iz), e;
        }
        _showElement(e) {
            let t = this._isAnimated(),
            ...
            let n = () => {
                this._config.focus && this._focustrap.activate(), (this._isTransitioning = !1), j.trigger(this._element, iK, { relatedTarget: e });
            };
    ...
    class nh extends z {
        ...
        show(e) {
            ...
            let i = () => {
                this._config.scroll || this._focustrap.activate(), j.trigger(this._element, nr, { relatedTarget: e });
            };
        ...
        _getConfig(e) {
            return h(i6, (e = { ...ne, ...J.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), nt), e;
        }
        _initializeBackDrop() {
            return new iD({ className: "offcanvas-backdrop", isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
        }
        _initializeFocusTrap() {
            return new iH({ trapElement: this._element });
        }
    ...
    let nm = "tooltip",
        ...
        ny = { AUTO: "auto", TOP: "top", RIGHT: y() ? "left" : "right", BOTTOM: "bottom", LEFT: y() ? "right" : "left" },
        nE = {
            animation: !0,
    ...
    class n9 extends z {
        ...
        show() {
            ...
            R.set(s, this.constructor.DATA_KEY, this),
                this._element.ownerDocument.documentElement.contains(this.tip) || (l.append(s), j.trigger(this._element, this.constructor.Event.INSERTED)),
            ...
            let e = this.getTipElement(),
                t = () => {
                    !this._isWithActiveTrigger() &&
                        (this._hoverState !== nC && e.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), j.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper());
                },
    ...
    class nX extends z {
        ...
        _getConfig(e) {
            return ((e = { ...nH, ...J.getDataAttributes(this._element), ...("object" == typeof e && e ? e : {}) }).target = c(e.target) || document.documentElement), h(nP, e, nB), e;
        }
        _getScrollTop() {
    ...
    class n5 extends z {
        ...
        show() {
            ...
            let a = () => {
                j.trigger(e, nQ, { relatedTarget: this._element }), j.trigger(this._element, n3, { relatedTarget: e });
            };
    ...
    class sp extends z {
        ...
        _getConfig(e) {
            return h(n7, (e = { ...sf, ...J.getDataAttributes(this._element), ...("object" == typeof e && e ? e : {}) }), this.constructor.DefaultType), e;
        }
        _maybeScheduleHide() {
    ...
    return q(sp), E(sp), { Alert: K, Button: Q, Carousel: eT, Collapse: eR, Dropdown: iw, Modal: iZ, Offcanvas: nh, Popover: n_, ScrollSpy: nX, Tab: n5, Toast: sp, Tooltip: n9 };
});
